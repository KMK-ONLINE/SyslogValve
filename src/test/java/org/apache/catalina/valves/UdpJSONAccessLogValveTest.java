...
public class UdpJSONAccessLogValveTest {
  ...
  public void shouldLogSuccessfully() throws InterruptedException {
    // Given
    final String message = "{\"request\":\"/?pretty=wow\",\"agent\":\"curl/7.47.0\",\"ident\":\"-\",\"verb\":\"GET\",\"type\":\"tomcataccess\",\"x_forwarded_for\":\"-\",\"request_time\":4,\"@timestamp\":\"2018-04-27T07:09:00.982+0000\",\"bytes\":11250,\"response\":200,\"clientip\":\"172.17.0.1\",\"httpversion\":\"HTTP/1.1\",\"timestamp\":\"27/Apr/2018:07:09:00 +0000\",\"vhost\":\"localhost\"}";

    // When
    udpJSONAccessLogValve.log(message);
    datagramServerThread.join();
  ...
  public void shouldNotLogOnNonJSONPayload() throws InterruptedException, SocketException {
    // Given
    final String message = "not-a-json-doc";
  ...
  public void shouldNotLogWhenMessageLengthLimitIsExceeded()
      throws SocketException, InterruptedException, ValveParserConfigurationException {
    // Given
    udpJSONAccessLogValve.setMessageLengthLimit("1");
    udpJSONAccessLogValve.parseIntConfigurations();

    final String message = "{\"name\":\"John\",\"age\":25}";
